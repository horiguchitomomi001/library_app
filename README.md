...
## システム概要
書籍の貸出・予約・管理を行うWebアプリケーションです。<br />
高校の図書館システムを想定しております。
...
※ 本アプリのUI/UXは現在改善中です。
機能面については一通りの動作確認を行っています。

| トップ画面 |　マイページ画面 |
| ---- | ---- |
| ![トップ画面イメージ](./client/img/topImg.png) | ![マイページ画面イメージ](./client/img/mypageImg.png) |

| 書籍管理画面 |　アカウント管理画面 |
| ---- | ---- |
| ![書籍管理画面イメージ](./client/img/bookMngImg.png) | ![アカウント管理画面イメージ](./client/img/userMngImg.png) |
